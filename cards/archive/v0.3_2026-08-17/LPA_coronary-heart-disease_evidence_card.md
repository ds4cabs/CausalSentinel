...
**Verdict:** GO — robust genetic, causal MR, and GWAS evidence strongly links LPA to coronary heart disease risk.
...
| Extra genetic evidence | `get_gwas_catalog` | 248 unique SNPs from 690/690 association rows |
...
Open Targets data demonstrates a high overall genetic association with coronary artery disorder, supported by extensive GWAS catalog mapping with hundreds of mapped associations. Retrieved Mendelian randomization results provide strong causal evidence linking the protein's cis instrument to coronary heart disease. Furthermore, gnomAD constraint metrics indicate the gene is loss-of-function tolerant, suggesting favorable target safety upon modulation.
...
- `get_clinvar_variants`: https://www.ncbi.nlm.nih.gov/clinvar/?term=LPA%5Bgene%5D — _ClinVar build Build260809-1055.1_
